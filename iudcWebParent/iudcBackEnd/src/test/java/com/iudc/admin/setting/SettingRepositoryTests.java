...
public class SettingRepositoryTests {
	...
	public void testCreateGeneralSettings() {
		Setting siteName = new Setting("IUDC", "IUDC iudc", SettingCategory.GENERAL);
		Setting siteLogo = new Setting("IUDC LOGO", "IUDC iudc.png", SettingCategory.GENERAL);
		Setting copyright = new Setting("COPYRIGHT IUDC", "Copyright (C) 2021 iudc Ltd.", SettingCategory.GENERAL);
