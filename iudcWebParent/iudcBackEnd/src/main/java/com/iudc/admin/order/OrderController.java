...
import com.iudc.admin.security.iudcUserDetails;
import com.iudc.admin.setting.SettingService;
...
public class OrderController {
	...
	public String listByPage(
			...
			@AuthenticationPrincipal iudcUserDetails loggedUser) {
	...
	public String deleteOrder(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		try {
			...
			ra.addFlashAttribute("message", "La orden ID " + id + " ha sido eliminada.");
		} catch (OrderNotFoundException ex) {
			ra.addFlashAttribute("message", ex.getMessage());
		}
	...
	public String saveOrder(Order order, HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "La orden ID " + order.getId() + " ha sido actualizada correctamente");
