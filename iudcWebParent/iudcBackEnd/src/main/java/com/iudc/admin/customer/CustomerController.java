package com.iudc.admin.customer;
...
public class CustomerController {
	...
	public String viewCustomer(@PathVariable("id") Integer id, Model model, RedirectAttributes ra) {
		try {
			...
			return "customers/customer_detail_modal"; //Regresa la pagina html customer_detail_modal
	...
	public String saveCustomer(Customer customer, Model model, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "El cliente con ID " + customer.getId() + " ha sido actualizado exitosamente.");
		return defaultRedirectURL;
	}
	...
	public String deleteCustomer(@PathVariable Integer id, RedirectAttributes ra) {
		try {
			service.delete(id);			
			ra.addFlashAttribute("message", "El cliente con ID " + id + " ha sido eliminado.");
