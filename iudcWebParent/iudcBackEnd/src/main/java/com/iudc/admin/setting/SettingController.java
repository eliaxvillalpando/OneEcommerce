...
public class SettingController {
	...
	public String saveGeneralSettings(@RequestParam("fileImage") MultipartFile multipartFile,
		...
		ra.addFlashAttribute("message", "Las configuraciones generales han sido guardadas.");
	...
	public String saveMailServerSetttings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "La configuración del servidor de correo ha sido guardada.");
	...
	public String saveMailTemplateSetttings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "El template del correo ha sido guardado.");
	...
	public String savePaymentSetttings(HttpServletRequest request, RedirectAttributes ra) {
		...
		ra.addFlashAttribute("message", "Las configuraciones de pago han sido guardadas.");
