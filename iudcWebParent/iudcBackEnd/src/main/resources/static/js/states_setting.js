...
function deleteState() {
	...
	$.ajax({
		...
		showToastMessage("ERROR: No fue posible conectar con el servidor.");
	});		
}
...
function changeFormStateToSelectedState() {
	...
	labelStateName.text("Estado/Provincia seleccionado:");
...
function loadStates4Country() {
	...
	$.get(url, function(responseJSON) {
		...
		changeFormStateToNew();
		showToastMessage("Todos los estados han sido cargados para el país " + selectedCountry.text());
	}).fail(function() {
		showToastMessage("ERROR: No fue posible conectar con el servidor.");
	});	
}
