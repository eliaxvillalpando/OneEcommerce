...
public class CustomerRepositoryTests {
	...
	public void testCreateCustomer1() {
		...
		customer.setFirstName("Sofi");
		customer.setLastName("Varona");
	...
	public void testUpdateCustomer() {
		...
		String lastName = "Varona Gutierrez";
	...
	public void testFindByVerificationCode() {
		String code = "code_123"; //Codigo se agrega manualmente en la base de datos.
