...
import com.iudc.product.ProductRepository;
	...
	public Integer addProduct(Integer productId, Integer quantity, Customer customer)
		...
		if (cartItem != null) {
			...
			if (updatedQuantity > 1000) {
				throw new ShoppingCartException("No es posible agregar mas " + quantity + " item(s)"
						+ " porque ya hay  " + cartItem.getQuantity() + " item(s) "
						+ "en el carrito. El maximo de item(s) son 1000.");
			}
		} else {
