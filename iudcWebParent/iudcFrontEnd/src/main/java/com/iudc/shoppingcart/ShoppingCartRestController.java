...
public class ShoppingCartRestController {
    ...
    public String removeProduct(@PathVariable("productId") Integer productId,
     ...
     @PostMapping("/cart/add-cotizacion-pedido/{codigoCotizacionId}/{quantity}")
    public String addCotizacionPedidoToCart(@PathVariable("codigoCotizacionId") Integer codigoCotizacionId,
            @PathVariable("quantity") Integer quantity, Customer customer) {

        try {
            Integer updatedQuantity = cartService.addProduct(codigoCotizacionId, quantity, customer);
